...
function Games() {
	const tiles = [
		{ name: 'Original Pong', video: 'https://www.youtube.com/embed/dQw4w9WgXcQ?controls=0&showinfo=0&rel=0&autoplay=1&mute=1&loop=1&playlist=dQw4w9WgXcQ' },
		{ name: 'Modded Pong', video: 'https://www.youtube.com/embed/dQw4w9WgXcQ?controls=0&showinfo=0&rel=0&autoplay=1&mute=1&loop=1&playlist=dQw4w9WgXcQ' },
		...
		<div className="flex flex-col items-center justify-center h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${backgroundImage})` }}>
			<div className="flex justify-center space-x-4 flex-wrap">
				{tiles.map((tile, index) => (
					<Link key={index} to="/originalpong" className="relative bg-white p-4 rounded shadow border-black border-2 text-black overflow-hidden m-2" style={{ width: '30vw', height: '16.875vw' }}>
